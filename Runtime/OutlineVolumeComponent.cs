...
public sealed class OutlineVolumeComponent : VolumeComponent, IPostProcessComponent
{
	...
	public ClampedIntParameter borderSize = new ClampedIntParameter(5, 2, 32);
	...
	[Header("Fall Offs")]
	public ClampedFloatParameter fallOff1 = new ClampedFloatParameter(0.0f, 0.0f, 1.0f);
	public ClampedFloatParameter fallOff2 = new ClampedFloatParameter(0.0f, 0.0f, 1.0f);
	public ClampedFloatParameter fallOff3 = new ClampedFloatParameter(0.0f, 0.0f, 1.0f);
